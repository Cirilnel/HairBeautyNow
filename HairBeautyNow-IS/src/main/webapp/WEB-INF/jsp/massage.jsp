...
<head>
  ...
  <link rel="stylesheet" href="static/style/massage.css">
...
<div class="main-content">
  ...
  <div class="service-container">
    <%
      ...
      if (serviziPerTipo != null && !serviziPerTipo.isEmpty()) {
        for (Map.Entry<String, List<Servizio>> entry : serviziPerTipo.entrySet()) {
          ...
          if (tipo.equals("massaggi")) { // Verifica che il tipo sia "Massage"
    %>
    ...
    %>
    <p>Non ci sono servizi di massaggio disponibili al momento.</p>
    <%
      }
    %>
