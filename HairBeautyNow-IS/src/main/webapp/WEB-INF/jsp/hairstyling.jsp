...
<head>
  ...
  <link rel="stylesheet" href="static/style/hairstyling.css">
...
<div class="main-content">
  ...
  <div class="service-container">
    <%
      ...
      if (serviziPerTipo != null && !serviziPerTipo.isEmpty()) {
        for (Map.Entry<String, List<Servizio>> entry : serviziPerTipo.entrySet()) {
          ...
          if (tipo.equals("hair styling")) { // Verifica che il tipo sia "hair styling"
    %>
    ...
    %>
    <p>Non ci sono servizi di hair styling disponibili al momento.</p>
    <%
      }
    %>
